...
export const PROJECTS_ITEMS = [
  {
    title: "Bicharada Universitária",
    body: "Alunos, professores e técnicos da Universidade Federal de Rio Grande se uniram para cuidar, castrar, alimentar e encontrar um lar amoroso para animais abandonados no campus.",
    image: "/bicharada.png",
    link: "https://www.instagram.com/bicharada.furg/"
  },
  {
  ...
  },
  {
    ...
    body: "Plataforma que discute racismo, especismo e veganismo dentro da comunidade afro, proporcionando informação e o  resgate do protagonismo preto na alimentação.",
    image: "/movimento-afro.png",
    link: "https://movimentoafrovegano.blogspot.com/"
  },
];
...
export const DOUBT_ITEMS = [
  {
    title: "É necessário ter equipamento sofisticados para realizar as receitas?",
    description: "Não! Acreditamos em receitas sofisticadas que podem ser feitas com utensílios simples e de fácil acesso."
  },
  {
    title: "Preciso ter experiência culinária para fazer o curso?",
    description: "Não! Desenvolvemos nosso curso para amadores e profissionais, nossa didática contempla desde os que não possuem experiência na cozinha, até aqueles que pretendem se aprofundar na culinária vegana."
  },
  {
    title: "No curso, o que está incluso?",
    description: "Você terá acesso a uma comunidade de alunos e alunas dispostos a compratilharem suas experiências, espaço para dúvidas e trocas com nossos colaboradores, leituras complementares em cada módulo do curso e, se você quiser, ao se inscrever na nossa newsletter, ficará por dentro das novidades que estamos preparando para os nossos alunos e alunas!"
  },
  {
    title: "Há acessibilidade no curso?",
    description: "Nosso curso conta com a tradução em libras e legendas descritivas para que a sua experiência seja inclusiva e respeitada. Caso sua necessidade específica não seja até então atendida, entre em contato para que possamos adequar nosso curso."
  },
  {
    title: "E se eu não me identificar com o curso?",
    description: "Você tem até 15 dias após sua inscrição para solicitar o seu dinheiro de volta, sem burocracia ou questionamento."
  },
  {
    title: "Até quando terei acesso ao curso?",
    description: "Você tem assinatura vitalícia! Seu curso pode ser acessado quando e quantas vezes preferir, assim como o suporte aos nossos colaboradores."
  },
  {
